...
@FoolFactoryBlockMarker(RubyOre.BLOCK_ID)
public class RubyOre extends FoolFactoryOreBlock {
    public static final String BLOCK_ID = "ruby_ore";

    public RubyOre() {
        super(FabricBlockSettings.of(Material.STONE).strength(2f).requiresTool(), RubyOre.BLOCK_ID);
    }
